...
const fetchProfile = async () => {
  try{
     const res = await axios.get(URL + "/api/v1/users/" + user._id)
...
const handleUserUpdate = async () => {
  setUpdated(false)
  try{
    const res = await axios.put(URL + "/api/v1/users/" + user._id, {username, email, password}, {withCredentials:true})
    // const res = await axios.put(URL + "/api/v1/users/" + user._id, {username, email, password})
...
const handleUserDelete = async() => {
  try{
    const res = await axios.delete(URL + "/api/v1/users/" + user._id, {withCredentials:true})
